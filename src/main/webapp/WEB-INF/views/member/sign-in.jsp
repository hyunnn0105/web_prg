...
<body>
    ...
    <div class="container wrap" style="margin: 200px auto;">
        <div class="row">
                        ...
                        <table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
                            ...
                            <tr>
                                <td   style="width: 100%; text-align: center; colspan: 2; margin-top: 24px; padding-top: 12px; border-top: 1px solid #ececec">
                                    ...
                                    <a id="custom-login-btn" href="https://kauth.kakao.com/oauth/authorize?client_id=${kakaoAppKey}&redirect_uri=http://localhost:8185${kakaoRedirect}&response_type=code">
