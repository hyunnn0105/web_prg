...
<body>
                ...
                <div class="card" style="width:200%;">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/member/sign-up" name="signup" id="signUpForm" method="post" style="margin-bottom: 0;">
                            <!-- 일단 다 일반회원 -> 나중에 올려주거나 문의 받기? BUT 프론트에서 바꿀 수 있어서 쓰지말자! -->
    ...
    <script>
        ...
        $(document).ready(function(){
            // 요소 노드 잡아오기
            //입력값 검증 정규표현식 : ^ -> ~로 시작하는 최소,최대 끝까지
            const getIdCheck = RegExp(/^[a-zA-Z0-9]{4,14}$/);
            const getPwCheck = RegExp(
                // 영문+숫사 사용 [특수기호 하나나도 사용] 시작을 특수문자 + 영문 하나 들어간거 조합
